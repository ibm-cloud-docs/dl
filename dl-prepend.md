...
1. From the AS prepends page, click **Create** to create an AS prepend, or use the Actions ![Actions menu](../icons/action-menu-icon.svg) menu to **Edit** or **Delete** an existing AS prepend.

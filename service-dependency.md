...
{: row-headers}
{: caption="IBM Cloud Direct Link Services - Data plane deployment service dependency information - Critical dependencies" caption-side="top"}
...
| IBM Cloud Business Support Services | Availability, Change management, Instance control | No | data-plane |  [Global](/docs/resiliency?topic=resiliency-ha-redundancy#global-platform)  |
| IBM Cloud Global Resource Catalog | Availability, Change management, Instance control, Security compliance | No | data-plane |  [Global](/docs/resiliency?topic=resiliency-ha-redundancy#global-platform)  |
...
| {{site.data.keyword.keymanagementservicefull}} | Availability, Change management, Disaster recovery, Instance control, Security compliance | No | data-plane |  Same region  |
{: row-headers}
{: caption="IBM Cloud Direct Link Services - Data plane deployment service dependency information - Significant dependencies" caption-side="top"}
...
{: row-headers}
{: caption="IBM Cloud Direct Link Services - Data plane deployment service dependency information - Minimal dependencies" caption-side="top"}
...
{: row-headers}
{: caption="IBM Cloud Direct Link Services - Control plane deployment service dependency information - Critical dependencies" caption-side="top"}
{: tab-title="Critical dependencies"}
...
{: row-headers}
{: caption="IBM Cloud Direct Link Services - Control plane deployment service dependency information - Significant dependencies" caption-side="top"}
{: tab-title="Significant dependencies"}
{: tab-group="service-dependency-data-for-directlink-Control-plane-deployment"}
{: class="comparison-tab-table"}
